                                ...
                                <ul class="text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90">
                                    <li>
                                        <div class="flex items-center px-4 py-4">
                                            <div class="flex-none">
                                                <img class="rounded-md w-10 h-10 object-cover" src="/assets/images/user-profile.jpg" alt="" />
                                            </div>
                                            <div class="ltr:pl-4 rtl:pr-4">
                                                <h4 class="text-base">
                                                    {{ username }}<span class="text-xs bg-success-light rounded text-success px-1 ltr:ml-2 rtl:ml-2">Admin</span>
                                                </h4>
...
function decodeToken() {
  ...
  if (token) {
    const decoded = jwtDecode<{ data: { UserName: string } }>(token);
    username.value = decoded.data.UserName;
    console.log('Decoded username:', username.value);
  }
}
