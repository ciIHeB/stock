            ...
            <div class="bg-white dark:bg-[#0e1726] h-full">
                <div class="flex justify-between items-center px-4 py-3">
                    <router-link to="/" class="main-logo flex items-center shrink-0">
                        ...
                        <span class="text-2xl ltr:ml-1.5 rtl:mr-1.5 font-semibold align-middle lg:inline dark:text-white-light">Trade Master</span>
                    </router-link>
                    <a
                        href="javascript:;"
                    ...
                    <ul class="relative font-semibold space-y-0.5 p-4 py-0">
                        <li class="menu nav-item">
                            ...
                            <button
                                type="button"
                                class="nav-link group w-full"
                                :class="{ active: activeDropdown === 'General' }"
                                @click="activeDropdown === 'General' ? (activeDropdown = null) : (activeDropdown = 'General')"
                            >
                                <div class="flex items-center">
                                    <svg
                                        class="group-hover:!text-primary"
                                ...
                                <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'General' }">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                </div>
                            </button>
                            <vue-collapsible :isOpen="activeDropdown === 'General'">
                                <ul class="sub-menu text-gray-500">
                                    <li>
                                        <router-link to="/apps/bank/list" @click="toggleMobileMenu">{{ $t('Bank') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/apps/company/list" @click="toggleMobileMenu">{{ $t('Company') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/apps/branch/list" @click="toggleMobileMenu">{{ $t('Branch') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/ax" @click="toggleMobileMenu">{{ $t('Setting Category') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/apps/PaymentSettings/list" @click="toggleMobileMenu">{{ $t('Payment Settings') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/apps/currency/list" @click="toggleMobileMenu">{{ $t('Currency') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/license" @click="toggleMobileMenu">{{ $t('License') }}</router-link>
                                    </li>
                                </ul>
                            </vue-collapsible>
                            ...
                            <vue-collapsible :isOpen="activeDropdown === 'Inventory'">
                                <ul class="sub-menu text-gray-500">
                                    <li>
                                        <router-link to="/apps/itemscategories/list" @click="toggleMobileMenu">{{ $t('Item Category') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/apps/itemsunit/list" @click="toggleMobileMenu">{{ $t('Item Unit & List') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/apps/itemsStatus/list" @click="toggleMobileMenu">{{ $t('Item Status & Kind') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/apps/items/list" @click="toggleMobileMenu">{{ $t('Items') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/apps/store/list" @click="toggleMobileMenu">{{ $t('Stores') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/inactiveitem" @click="toggleMobileMenu">{{ $t('Inactive Item') }}</router-link>
                                    </li>
                            ...
                            <vue-collapsible :isOpen="activeDropdown === 'Customers'">
                                <ul class="sub-menu text-gray-500">
                                    <li>
                                        <router-link to="/apps/customerclass/list" @click="toggleMobileMenu">{{ $t('Customer Class & Cluster') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/apps/customercategory/list" @click="toggleMobileMenu">{{ $t('Customer Category') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/apps/customers/list" @click="toggleMobileMenu">{{ $t('Customers') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/inactivecustomers" @click="toggleMobileMenu">{{ $t('Inactive Customer') }}</router-link>
                                    </li>
                                </ul>
                            </vue-collapsible>
                            ...
                            <button
                                type="button"
                                class="nav-link group w-full"
                                :class="{ active: activeDropdown === 'Back Office Users' }"
                                @click="activeDropdown === 'Back Office Users' ? (activeDropdown = null) : (activeDropdown = 'Back Office Users')"
                            >
                                <div class="flex items-center">
                                    <svg
                                        class="group-hover:!text-primary"
                                ...
                                <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'Back Office Users' }">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                </div>
                            </button>
                            <vue-collapsible :isOpen="activeDropdown === 'Back Office Users'">
                                <ul class="sub-menu text-gray-500">
                                    <li>
                                        <router-link to="/apps/usergroup/list" @click="toggleMobileMenu">{{ $t('User group') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/apps/users/list" @click="toggleMobileMenu">{{ $t('User Account') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/regionalmanager" @click="toggleMobileMenu">{{ $t('Regional Manager') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/salesmanager" @click="toggleMobileMenu">{{ $t('Sales Manager') }}</router-link>
                                    </li>
                                </ul>
                            </vue-collapsible>
                            ...
                            <button
                                type="button"
                                class="nav-link group w-full"
                                :class="{ active: activeDropdown === 'Hand Held' }"
                                @click="activeDropdown === 'Hand Held' ? (activeDropdown = null) : (activeDropdown = 'Hand Held')"
                            >
                                <div class="flex items-center">
                                    <svg
                                        class="group-hover:!text-primary"
                                ...
                                <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'Hand Held' }">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                </div>
                            </button>
                            <vue-collapsible :isOpen="activeDropdown === 'Hand Held'">
                                <ul class="sub-menu text-gray-500">
                                    <li>
                                        <router-link to="/apps/usersmob/list" @click="toggleMobileMenu">{{ $t('HH User') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/apps/owners/list" @click="toggleMobileMenu">{{ $t('HH Owner') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/apps/ownersRoutes/list" @click="toggleMobileMenu">{{ $t('Owner Routes') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/inactiveowners" @click="toggleMobileMenu">{{ $t('Inactive Owners') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/acesscard" @click="toggleMobileMenu">{{ $t('Access Card') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/supervisor" @click="toggleMobileMenu">{{ $t('Supervisors') }}</router-link>
                                    </li>
                                </ul>
                            </vue-collapsible>
                            ...
                            <button
                                type="button"
                                class="nav-link group w-full"
                                :class="{ active: activeDropdown === 'Promotions' }"
                                @click="activeDropdown === 'Promotions' ? (activeDropdown = null) : (activeDropdown = 'Promotions')"
                            >
                                <div class="flex items-center">
                                    <svg
                                        class="group-hover:!text-primary"
                                ...
                                <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'Promotions' }">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                </div>
                            </button>
                            <vue-collapsible :isOpen="activeDropdown === 'Promotions'">
                                <ul class="sub-menu text-gray-500">
                                    <li>
                                        <router-link to="/printer" @click="toggleMobileMenu">{{ $t('Defined Promotions') }}</router-link>
                                    </li>
                                </ul>
                            </vue-collapsible>    
                            <button
                                type="button"
                                class="nav-link group w-full"
                                :class="{ active: activeDropdown === 'Warehouse Operations' }"
                                @click="activeDropdown === 'Warehouse Operations' ? (activeDropdown = null) : (activeDropdown = 'Warehouse Operations')"
                            >
                                <div class="flex items-center">
                                    <svg
                                        class="group-hover:!text-primary"
                                ...
                                <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'Warehouse Operations' }">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                </div>
                            </button>
                            <vue-collapsible :isOpen="activeDropdown === 'Warehouse Operations'">
                                <ul class="sub-menu text-gray-500">
                                    <li>
                                        <router-link to="/apps/boload/add" @click="toggleMobileMenu">{{ $t('BO Store Load ') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/apps/bounload/add" @click="toggleMobileMenu">{{ $t('BO Store UnLoad') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/apps/vload/list" @click="toggleMobileMenu">{{ $t('Salesman Auto Load') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/apps/vuload/add" @click="toggleMobileMenu">{{ $t('Salesman Auto Unload') }}</router-link>
                                    </li>
                                </ul>
                            </vue-collapsible>
                            ...
                            <button
                                type="button"
                                class="nav-link group w-full"
                                :class="{ active: activeDropdown === 'Finance' }"
                                @click="activeDropdown === 'Finance' ? (activeDropdown = null) : (activeDropdown = 'Finance')"
                            >
                                <div class="flex items-center">
                                    <svg
                                        class="group-hover:!text-primary"
                            ...
                            <vue-collapsible :isOpen="activeDropdown === 'Finance'">
                                <ul class="sub-menu text-gray-500">
                                    <li>
                                        <router-link to="/cashbox" @click="toggleMobileMenu">{{ $t('Cash Box Office') }}</router-link>
                                    </li>
                                </ul>
                            </vue-collapsible>
