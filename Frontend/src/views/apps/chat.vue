            ...
            >
                ...
                <div class="!mt-0">
                    <perfect-scrollbar
                        ...
                        class="chat-users relative h-full min-h-[100px] sm:h-[calc(100vh_-_357px)] space-y-0.5 pr-3.5 -mr-3.5"
                    >
                    ...
                    <div class="flex items-center justify-center h-full relative p-4">
                        ...
                        <div class="py-8 flex items-center justify-center flex-col">
                            <div class="w-[280px] md:w-[430px] mb-8 h-[calc(100vh_-_320px)] min-h-[120px] text-white dark:text-[#0e1726]">
                                ...
                                >
                                    <ellipse cx="418.64354" cy="727.19434" rx="352" ry="18" :fill="store.theme === 'dark' ? '#888ea8' : '#e6e6e6'" />
                                    <path
                                    ...
                                    <path
                                        ...
                                        transform="translate(-154.35252 -77.40283)"
                                        :fill="store.theme === 'dark' ? '#888ea8' : '#e6e6e6'"
                                    />
                                    <path
                                    ...
                                    <path
                                        ...
                                        :fill="store.theme === 'dark' ? '#888ea8' : '#e6e6e6'"
                                    />
                                    <ellipse cx="554.64354" cy="605.66091" rx="24.50394" ry="2.71961" :fill="store.theme === 'dark' ? '#888ea8' : '#e6e6e6'" />
                                    <ellipse cx="335.64354" cy="285.66091" rx="24.50394" ry="2.71961" :fill="store.theme === 'dark' ? '#888ea8' : '#e6e6e6'" />
                                </svg>
                            </div>
