            ...
            <div class="datatable invoice-table">
                <div class="mb-4.5 px-5 flex md:items-center md:flex-row flex-col gap-5">
                    <div class="flex items-center gap-2">
                        ...
                        <router-link to="/apps/ownersRoutes/add" class="btn btn-primary gap-2">
                            <svg
                ...
                <template #actions="data">
                        <div class="flex gap-4 items-center justify-center">
                            <router-link :to="`/apps/ownersRoutes/edit/${data.value.RouteID}`"  class="hover:text-info">
                            ...
                            <router-link :to="`/apps/ownersRoutes/${data.value.RouteID}`" class="hover:text-primary">
                            ...
                            <button type="button" class="hover:text-danger" @click="deleteRow(`${data.value.itemID}`)"> 
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5">
...
<script lang="ts" setup>
    ...
    const search = ref('');
    const cols = ref([
        { field: 'RouteDescLan1', title: 'Route Name' },
...
onMounted(() => {
    ...
    console.log("item: ", item)
        ...
        try {
            await Promise.all([
                salPriceListService.deletePriceList(item),
