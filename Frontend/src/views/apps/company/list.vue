            ...
            <div class="datatable invoice-table">
                <div class="mb-4.5 px-5 flex md:items-center md:flex-row flex-col gap-5">
                    <div class="flex items-center gap-2">
                        ...
                        <router-link to="/apps/company/add" class="btn btn-primary gap-2">
                            <svg
                ...
                <template #id="data">
                    ...
                    <template #actions="data">
                        <div class="flex gap-4 items-center justify-center">
                            <router-link :to="`/apps/company/edit/${data.value.CompanyID}`"  class="hover:text-info">
                            ...
                            <router-link :to="`/apps/company/preview?company_id=${data.value.CompanyID}`" class="hover:text-primary">
                            ...
                            <button type="button" class="hover:text-danger" @click="deleteRow(`${data.value.CompanyID}`)">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5">
...
<script lang="ts" setup>
    ...
    const cols = ref([
        ...
        { field: 'CompanyDescLan1', title: 'Company Name' },
        { field: 'CompanyVatNumber', title: 'Company Vat Number' },
        { field: 'CompanyAddress', title: 'Company Address' },
        { field: 'CompanyTel', title: 'Company Tel' },
    ...
    try {
        const companyData = await companyService.getcompanies();
            company.value = companyData.map((company: any) => ({
                ...company,
                LastUpdateDate: formatDate(company.LastUpdateDate)
            }));
    } catch (error) {
...
onMounted(() => {
   ...
   const deleteRow = async (item: any = null) => {
    console.log("item: ", item)
        ...
        try {
           await companyService.deleteCompany(item);
           await fetchCompany(); 
