        ...
        <div class="panel sm:w-[480px] m-6 max-w-lg w-full">
            ...
            <form class="space-y-5" @submit.prevent="router.push('/')">
                <div>
                    ...
                    <input id="email" type="email" class="form-input" placeholder="Enter Username" />
                </div>
                <div>
           ...
           <!-- <div
            ...
            <p class="text-center">
                Dont't have an account ? <router-link to="/auth/boxed-signup" class="text-primary font-bold hover:underline">Sign Up</router-link>
            </p>-->
        </div>
    </div>
</template>
